...
from .utils.table_io import DEFAULT_PARQUET_ENGINE, write_table_fast
    ...
    if eligible.empty:
        ...
        shape_tracks = pd.DataFrame(
            columns=[
                ...
                "n_valid_daily_observations",
                "S_rms",
                "mono_ratio",
                "dir_change_mean_deg",
                "dir_change_max_deg_p95",
                "upright_s_threshold_used",
                "rule_version",
            ]
        )
        ...
        for shape in SHAPE_CLASSES:
            ...
            shape_tracks.to_csv(folder / "tracks.csv", index=False)
        thresholds = {
            ...
            "upright_mode": "not_computed_no_eligible_tracks",
            "upright_s_threshold_used": None,
            ...
            "n_eligible_tracks": 0,
            "n_daily_metric_rows": 0,
            "shape_counts": {},
            "note": "No Hua tracks passed shape eligibility in this date/configuration window.",
        }
        _dump_mapping(shape_dir / "shape_thresholds.yaml", thresholds)
        return {
            "eligible_tracks": 0,
            "daily_metrics": 0,
            "shape_tracks": 0,
            "no_eligible_tracks": 1,
        }
