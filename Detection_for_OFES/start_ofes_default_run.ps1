...
$root = "E:\DATA\01_Eddy_correspond\02_OFES\Fromthebeginning\runs\$Profile\$token"
$logs = Join-Path $root 'logs'
New-Item -ItemType Directory -Force -Path $logs | Out-Null

$arguments = "-m Detection_for_OFES.workflows.default_pipeline --profile $Profile --start $Start --end $End --stages $Stages"
