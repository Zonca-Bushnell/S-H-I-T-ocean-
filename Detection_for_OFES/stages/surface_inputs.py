...
from Detection_for_OFES.io.ofes import ctl_path, parse_ctl, read_variable_latlon_daily_only
from Detection_for_OFES.io.netcdf import regrid_scalar_to_velocity
...
def main() -> None:
    ...
    written = build_eta_surface_inputs(
        args.data_root, args.velocity_root, args.output_root,
        parse_day(args.start), parse_day(args.end), overwrite=args.overwrite,
    )
